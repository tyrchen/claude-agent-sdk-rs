...
**Example Usage:**
```rust
use claude_agent_sdk::{tool, create_sdk_mcp_server, ClaudeAgentOptions, ToolResult, ToolResultContent};
use serde_json::json;
...
use claude_agent_sdk::{query, Message, ContentBlock, ClaudeAgentOptions};
use futures::StreamExt;
